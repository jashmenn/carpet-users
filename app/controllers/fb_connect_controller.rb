...
# load page
#   if someone is connected to facebook
#     post "fb connected user"

# do same as signup below
...
# in fb connected user you say
#   if does this fb id already exist?
#     then log the user in and be happy
#   else
#     user = say "type in a username" 
#     if user exists
#       say you are linking an existing account to facebook, what is your password
#     else
#       say yay this is your new username
#       create a user
#       get their email somehow
